...
export interface EditNodeModalProps {
  show: boolean;
  editNodeName: string;
  onEditNodeNameChange: (name: string) => void;
  editNodeType: NodeType;
  onEditNodeTypeChange: (type: NodeType) => void;
  editNodeConfigId: string;
  onEditNodeConfigIdChange: (configId: string) => void;
        ...
        <form onSubmit={onSubmit} className="space-y-4">
          <div className="space-y-1">
            ...
            <Input
              ...
              value={editNodeName}
              onChange={(e) => onEditNodeNameChange(e.target.value)}
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-1">
              ...
              <NativeSelect
                value={editNodeType}
                onChange={(e) =>
                  onEditNodeTypeChange(e.target.value as NodeType)
                }
                className="w-full"
                size="sm"
              >
            ...
            <div className="space-y-1">
              ...
              <NativeSelect
                value={editNodeConfigId}
                onChange={(e) => onEditNodeConfigIdChange(e.target.value)}
                className="w-full"
                size="sm"
              >
