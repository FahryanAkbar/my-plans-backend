      ...
      <div className="space-y-4 w-full">
        ...
        <div className="p-3.5 rounded-xl border border-border/30 bg-card/45 space-y-2.5">
          ...
          <div className="space-y-2 text-xs">
            ...
            <div className="flex justify-between items-center">
              ...
              <span className="font-semibold text-foreground/90">{nodeCount} nodes</span>
            </div>
            <div className="flex justify-between items-center">
              <span className="text-muted-foreground/70">Uptime Average:</span>
              <span className="font-bold text-foreground/90">{averageUptime}</span>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-3.5 pt-2 border-t border-border/20">
          <div className="flex items-center justify-between">
            ...
            <Switch checked={showLabels} onCheckedChange={onShowLabelsChange} id="label-switch" />
          </div>
          ...
          <div className="flex items-center justify-between">
            ...
            <Switch checked={!lowPowerMode} onCheckedChange={(val) => onLowPowerModeChange(!val)} id="power-switch" />
          </div>
        </div>
      </div>
