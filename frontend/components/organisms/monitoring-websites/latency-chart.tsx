...
export function LatencyCharts({ className, projectId, configId, range: controlledRange }: LatencyChartsProps) {
  const [internalRange, setInternalRange] = React.useState<AnalyticsRange>("1h");
